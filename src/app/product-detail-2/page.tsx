        ...
        <div className='flex mt-3 justify-between'>
          {variants.map((variant, index) => (
            <div
              ...
              className={`relative  size-10   rounded-full border-2 cursor-pointer ${
      ...
      <div>
        <div className='flex justify-between font-medium text-sm'>
          <label htmlFor=''>
            <span className=''>
              Kích thước:
              <span className='ml-1 font-semibold'>{sizeSelected}cm</span>
            </span>
          </label>
        </div>
        <div className='grid grid-cols-3 gap-2 mt-3'>
          {allOfSizes.map((size, index) => {
            ...
            return (
              <div
                key={index}
                className={`relative h-10 sm:h-11 rounded-md border flex items-center justify-center 
            ...
            <div className='flex items-center justify-between space-x-5'>
              ...
              <a href='#reviews' className='flex items-center text-sm font-medium'>
                ...
                <span className='ml-1.5 flex'>
                  ...
                  <span className='text-slate-700 dark:text-slate-400 underline'>142 reviews</span>
                </span>
              </a>
            </div>
  ...
  const renderSection1 = () => {
    return (
      <div className='listingSection__wrap !space-y-6'>
        <div>
          <h2 className='text-2xl md:text-3xl font-semibold'>Heavy Weight Hoodie</h2>
        ...
        <header className='container mt-8 sm:mt-10'>
          <div className='relative '>
            <div className='grid grid-cols-2 md:grid-cols-3 gap-3 lg:gap-6'>
              ...
              {/*  */}
              {[LIST_IMAGES_GALLERY_DEMO[2], LIST_IMAGES_GALLERY_DEMO[3]].map((item, index) => (
                <div
                  key={index}
