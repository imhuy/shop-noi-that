...
import full1Img from "@/images/products/full1.webp";
import full11Img from "@/images/products/full1-1.webp";
import full12Img from "@/images/products/full1-2.webp";
import full13Img from "@/images/products/full1-3.webp";
//
...
export const DEMO_LARGE_PRODUCTS = [
  {
    ...
    name: "Giường Ngủ Phong Cách Hàn M10",
    desc: "Orange",
    price: 52,
  },
  {
    id: 2,
    images: [full1Img, full1Img, full1Img, full1Img],
    name: "Giường Ngủ Phong Cách Hàn M20",
  ...
  },
  {
    id: 3,
    images: [full1Img, full1Img, full1Img, full1Img],
    name: "Giường Ngủ Phong Cách Hàn M30",
    desc: "3 Sizes Available",
    price: 60,
  },
];

const SectionSliderLargeProduct2: FC<SectionSliderLargeProduct2Props> = ({ className = "", cardStyle = "style1" }) => {
