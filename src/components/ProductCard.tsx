    ...
    <>
      <div className={`nc-ProductCard relative flex flex-col bg-transparent ${className}`}>
        ...
        <div className='relative flex-shrink-0 bg-slate-50 dark:bg-slate-300 rounded-md overflow-hidden z-1 group'>
          <Link href={{ pathname: `/product-detail/${link}` }} className='block'>
            <NcImage
        ...
        <div className='space-y-4 px-2.5 pt-5 pb-2.5'>
          ...
          <div className='flex flex-col justify-between items-start '>
            <div className='flex items-center '>
              <Prices price={2000000} /> <span className='text-xs bg-slate-100 px-2 mx-2'>-15%</span>
            </div>

            <div className='flex items-center mb-0.5'>
              <StarIcon className='w-5 h-5 pb-[1px] text-amber-400' />
              <span className='text-sm ms-1 text-slate-500 dark:text-slate-400'>
                {rating || ""} ({numberOfReviews || 0} đã bán)
              </span>
            </div>
          </div>
        </div>
