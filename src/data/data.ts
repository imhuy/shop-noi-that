...
export const PRODUCTS: Product[] = [
  {
    id: 1,
    name: "Giường Ngủ Phong Cách Hàn Togismart GH020xxx",
    description: "Brown cockroach wings",
    price: 74,
    image: productImgs[0],
    category: "Category 1",
    tags: ["tag1", "tag2"],
    link: "giuong-ngu-phong-cach-han-togismart-gh020",
    variants: DEMO_VARIANTS,
    variantType: "image",
    sizes: ["120x200", "140x200", "160x200", "180x200", "200x200", "220x200"],
    allOfSizes: ["120x200", "140x200", "160x200", "180x200", "200x200", "220x200"],
    status: "New in",
    rating: "4.4",
    numberOfReviews: 98,
  },
  {
    id: 2,
    name: "Giường Ngủ Phong Cách Hàn Togismart GH020",
